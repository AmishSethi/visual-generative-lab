#!/usr/bin/env python
"""Evaluate the shape-vocabulary coverage runs (coverage fraction vs number of combinations K).
...
def evaluate_run(name, results_dir, dataset_dir, num_samples, steps, device, dump_dir=None):
    ...
    # The colour vocabulary is 8 or 16 according to the cell; the embedding table,
