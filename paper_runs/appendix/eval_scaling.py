#!/usr/bin/env python
"""Evaluate the data-scaling sweep with the paper's own metrics.
Nested training sets of 10k-80k images are trained at a fixed optimizer-step
budget; the question is whether more data changes extrapolation.

The appendix results tree is laid out as
...
from paper_runs.appendix.manifest import EVAL_ROOT, RESULTS_ROOT, SCALING_SIZES
