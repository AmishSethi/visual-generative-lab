...
counter_crossval.py establishes what the counters can do on ground truth; this
script measures what they say about the model's actual generations, and how
often those generations place objects on top of each other -- the regime in
which every counter collapses.  Agreement across independent counters separates
a real count failure from a metric artifact.
"""
import argparse
import json
import sys
...
from paper_runs.appendix.counter_crossval import COUNTERS, CIRCLE_RADIUS, _binary_mask
