...
Both are external-validity checks: they test whether the failures VGL isolates
under controlled conditions are the same failures production text-to-image
systems exhibit.
"""
...
from paper_runs.appendix.t2i_score import (
...
def main():
    ...
    parser.add_argument("--out", type=Path,
                        default=Path(f"{VGL_ROOT}/appendix/eval/t2i/analysis.json"))
