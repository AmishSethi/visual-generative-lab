...
Requires a separate environment with torch 2.7 / diffusers 0.39 /
transformers 4.54; the DiT training environment does not include transformers.
"""
import os as _os
...
from paper_runs.appendix.t2i_prompts import NEGATIVE_PROMPT, build_all
...
MODELS = {
    ...
    # FLUX.1 repos are gated behind an approval list, so this is how the FLUX
    # architecture enters the comparison without gated access.
    "shuttle3": {
