#!/usr/bin/env python
"""Does the extrapolation boundary follow the training support?

Extrapolation failures could reflect the numeric scale of the conditioning
input or the design of the training range rather than a failure to learn the
visual rule.  The two hypotheses make different predictions when the support
is moved:
...
from paper_runs.appendix.manifest import EVAL_ROOT, RANGE_SPECS
