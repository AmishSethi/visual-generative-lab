#!/usr/bin/env python
"""Nearest-neighbour memorisation probe.

Diagnostic for whether poor interpolation/extrapolation reflects memorisation
or nearest-support behaviour rather than learned skill structure.  The paper
does not currently report this measurement.
...
from paper_runs.appendix.manifest import DATASET_ROOT, EVAL_ROOT, TABLE2_DATASETS
