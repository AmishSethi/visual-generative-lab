...
Reviewer HeVs, weakness 2: "the poor performance of the VAE latent setting in
Table 2 may partly come from the low-resolution toy nature of the data, where
the VAE bottleneck can discard fine-grained geometric information."

This tests the hypothesis directly and needs no trained model.  Ground-truth
...
latent-space model could achieve:
  ...
  * a low ceiling confirms HeVs' explanation and turns the Table 1 latent row
    into something explained rather than defended;
