#!/usr/bin/env python
"""Cross-validate three independent object counters (Reviewer yLdq, question 3).

yLdq asks whether the count failure is poor generalisation over discrete
numbers, or an artefact of object placement, overlap and the connected-component
