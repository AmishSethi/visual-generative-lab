...
but two rebuttal probes need the pixels themselves:

  * the three-counter cross-validation (yLdq q3) must re-score the *same*
    generations with alternative counters and measure how often objects overlap;
  * the nearest-neighbour memorisation probe (HeVs w3) must compare generations
