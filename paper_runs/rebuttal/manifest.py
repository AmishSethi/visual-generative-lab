"""Paths and specs for the NeurIPS 2026 rebuttal experiments.

Everything new lives under REBUTTAL_ROOT so the paper-locked table2/table3
...
REBUTTAL_ROOT = Path(f"{VGL_ROOT}/REBUTTAL")

DATASET_ROOT = REBUTTAL_ROOT / "datasets"
RESULTS_ROOT = REBUTTAL_ROOT / "results"
SLURM_ROOT = REBUTTAL_ROOT / "slurm"
LOG_ROOT = REBUTTAL_ROOT / "logs"
EVAL_ROOT = REBUTTAL_ROOT / "eval"
...
# ---------------------------------------------------------------------------
# E-SCALE: does more data fix extrapolation?  (Reviewer HeVs, weakness 3)
#
...
# ---------------------------------------------------------------------------
# E-RES: 128x128 replication.  (Reviewers HeVs w2/w5, yLdq w1)
#
...
# ---------------------------------------------------------------------------
# E-RANGE: does the extrapolation boundary follow the training support?
# (Reviewer yLdq w2)
#
# yLdq argues our failures may come from "condition encoding, numerical
