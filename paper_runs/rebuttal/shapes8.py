"""Eight-shape vocabulary for the coverage-vs-K experiment (Reviewer XDWw).

The paper uses four shapes (circle, square, triangle, diamond).  Reviewer XDWw
argues our coverage result may really be a "number of unique combinations"
result, and predicts that with a larger shape vocabulary the coverage fraction
could be lowered while accuracy stays equal or higher.  Testing that needs a
bigger vocabulary, so we add pentagon, hexagon, star and cross.
