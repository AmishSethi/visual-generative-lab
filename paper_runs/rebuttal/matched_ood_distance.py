...
Reviewer yLdq, question 1: "Is rotation still easier to extrapolate after
controlling for the numerical scale and extrapolation distance of all
...
SKILL_SOURCES = {
    ...
    # table, which made rotation look far weaker than its published number.
